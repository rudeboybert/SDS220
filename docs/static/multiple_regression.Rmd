...
The slopes of the lines in the plots of the interaction model and parallel slopes model are not that different. So the additional complexity of the interaction model **is not warranted**; go with the simpler parallel slopes model. 
...
The slopes of the lines in the plots of the interaction model and parallel slopes model are somewhat different. So the additional complexity of the interaction model **is warranted**; go with the more complex interaction model.
