...
* Time window: **Friday 4/10 through Wednesday 4/15**. TODO: Exact times TBD.
* In preparation for badge challenge:
...
* "Completing the badge challenge":
    ...
    + Remember that you only have to do as many questions as you are ready for. If a question has multiple parts, you **must** attempt all parts to earn above *X* (cannot be assessed).
    + See example here TODO: post example
* "Submitting the badge challenge":
    ...
    + TODO: Submit raw picture or have students use one of the "scanner" apps.
* Honor code:
    + Closed-book, no internet, and individually completed. You may only use your laptop to view the badge challenge
    + You will be given (TODO: set number of minutes) mins to complete it. **Timestamps will be strictly enforced. Any badge challengs with pairs of timestamps indicating that more time than allowed was taken will be subject to an honor board case.**
...
* Badges: Lectures 1-(TODO: set lecture number)  & Labs 1-(TODO: set lab number).  In other words everything up to and including the resampling activity and confidence intervals.
* What to study:
    + Badge challenge 1!
...
* Time window: **Friday 4/24 through Wednesday 4/29**. TODO: Exact times TBD.
* 
...
* Time window: **Exam week: Monday 5/4 through Friday 5/8**. TODO: Exact times TBD.
* More details to be posted later.


## Badges 1-15
    
* Badges: All Lectures & all Labs.  In other words everything.
* What to study:
