...
* Read moderndive
    ...
    + Chapter 5.2 on "tidy" data format.
* Read instructions:
    ...
    + Download and knit the following `data_proposal.Rmd` template R Markdown file.
...
* If you need help wrangling or "tidying" your data, go to the Spinelli Center Tutoring hours: Sun-Thurs 7-9pm in Sabin-Reed 301.
* Edit the `data_proposal.Rmd` template R Markdown file to match your project data.
...
# 3. Proposal due: Fri 3/8 5pm {#proposal}
