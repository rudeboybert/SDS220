...
The group leader will then:

1. Create two Slack direct messages:
    * One with all your group members + myself + Jenny: Ask questions to Jenny and myself here to that we're all on the same page.
