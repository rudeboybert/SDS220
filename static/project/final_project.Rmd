...
-->
![](https://cms.nhl.bamgrid.com/images/photos/309842964/1200x630/cut.jpg){width=400px}
...
```{r}
# Change this code to load your data from the web and do any data cleaning here:
...
- Your initial model selection choice: interaction or parallel slopes model
