...
1. Disclaimer: Just because things seem good now doesn't mean your project data is set for semester. Unforseen problems may crop up during the next phase on data wrangling, at which point you may need to revise your data. This is a reality of data collection in the real world!
...
The 220 instructor team is working on distilling this course down to the most important ideas of this class, regardless of the semester or the situation. In pursuit of that distillation, we are re-examining each aspect of the course, including the project. 

Our original goals for the project were: 

1. Exposing students to the entire data/science pipeline as shown [here](https://r4ds.had.co.nz/introduction.html){target="_blank"}, in particular emphasizing exploratory data analysis (or EDA) . 
1. Convincing students that data collection & wrangling are **essential yet difficult tasks** in statistics. In other words, the high-curated ready-to-go datasets (like those used in our textbook) are not the norm in statistics research.
1. Consolidating the many many concepts needed to understand inference for multiple regression models into one assignment. 
1. Encouraging students to develop a sense of ownership over their work, as compared to problem sets and badge challenges where we -- the instructors -- select the data, the question of interest, and the method for you. 

Because a remote learning model of education makes both (1) coordinating group work and (2) getting help with the coding aspects of the project particularly difficult, we’ve decided to revise the project.

In this revision, we are balancing working in a learning community with removing the stress of group work. Like the original project, this revised version will have 4 phases, but in this revision, the last two phases will differ substantially from the original version:
...
As stated above, we have four goals for this project, and at this point in the process (i.e. after phase two submission) we believe that each statistician in SDS/MTH 220 has explicit experience with at least one of the goals. So for the third phase “Project Submission” each student will be submitting a 3 to 5 page double spaced essay on your experience. Action Items:
...
1. Then with these notes in mind, read the feedback from Phase 2 and review the feedback from Phase 1. Does the feedback surprise you? Compare and contrast the feedback with your notes. 
1. Now is the time to loop in your group. Have a discussion over either Zoom or slack about 1) the goals for the project and 2) the feedback. It’s totally normal if each of you resonate with a different goal. Even though you have worked in a group, you are a collection of individuals with different experiences. 
1. With all of this in mind, respond to the following prompt:

> This project has 4 original goals in mind. Select at least one of these goals and discuss how your work so far on the project has already accomplished this goal. Note that we are asking you to write authentically about your experience, not to tell us what you think we want to hear about your work on the project so far. 

There are a few logistics:

* Your paper must be written by you, but in a footnote, endnote, or appendix, please note when you met with your group and one thing that your group discussed that was not included in your reflection.
* Your paper needs to be 3 to 5 pages, double-spaced with 1-in margins. It needs to be submitted via model as a PDF. 
