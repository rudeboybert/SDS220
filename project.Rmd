...
1. Asking questions:
    1. For general project question: ask in `final_project` channel in Slack
    1. For questions specific to your group: ask in group DM you created in project proposal phase.
...
1. The `project_proposal.Rmd` R Markdown file. This file **must** knit
1. The `project_proposal.html` HTML output file
