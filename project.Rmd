...
<!--
Note for future: instead of assigning groups at random to people who need them,
use a blocked randomization scheme. For ex: by major or some interest (sports
team, hometown, etc). That way there will be less potential for disagreement
over what dataset to use, which Adriana B. pointed out happened in her 192
mini-project 3.
-->
