...
1. Hot tip from this [tweet](https://twitter.com/OscarBaruffa/status/1502255846465671170): You can `View()` contents of a data frame in RStudio by:
    1. macOS: Command + Clicking the name of the data frame in your code
    1. Windows: CTRL + Clicking the name of the data frame in your code

## Today's Topics/Activities

### 1. Chalk talk

1. Example of CLT working for non-normal population distributions
...
1. Polls in MD 7.4
1. Central Limit Theorem: Watch bunny video
