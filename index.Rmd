...
<iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQM-5FVt5BKJZsfElEV19NwD2MXGgSVUfGLB7dUoD0MbCU6Dkzqx66UMxbgqMaiS6H8CP8numV5Xaf-/pubhtml?gid=1753108531&amp;single=true&amp;widget=true&amp;headers=false" width="100%" height="1010"></iframe>
...
Example: compare the "meta-data" of the three data frame outputs by running the code below. All have `A tibble: 32 x 11` meta-data indicating the number of rows and columns, but only the second output has `Groups: cut [5]` grouping structure meta-data based on five levels of categorical variable `cut`: `"Fair"`, `"Good"`, `"Very Good"`, `"Premium"`, `"Ideal"`.
...
* Reminder that ["Multiple Imputation Methods in Cluster Randomzied Trials"](static/talks/bailey.png){target="_blank"} by Prof. Brittney Bailey from Amherst College is tomorrow 12:10pm in McConnell B15!
* [DataFest](http://www.science.smith.edu/datafest/){target="_blank"} is a weekend-long "data science hackathon" for teams of up to 5 students and is at UMass the weekend of March 29-31! [Info session](static/images/datafest2019.pdf){target="_blank"} by Prof. Randi Garcia today 7-8pm in Sabin-Reed 301 (here)!
...
<center>
![](static/talks/bailey.png){ width=700px }
</center>
