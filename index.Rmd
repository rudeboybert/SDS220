...
1. Midterms
    ...
    1. Be sure to read [Midterm IV info](midterms.html#midtermIV)
    1. Be sure to check that all your proficiency scores on Moodle under Grades are correct
1. Office hours
    1. Online: Friday during lecture time
    1. Exam week office hours posted on calendar in Syllabus
1. Unlike textbooks that students often sell at the end of the semester, ModernDive will always be available at [moderndive.com](https://moderndive.com/){target="_blank"}


## Closing notes

1. See Slack `#general`
1. Reflection on standards-based grading and how semester went
1. Time for course evals
1. Thank you to Beth Brown and all Spinelli Tutors
1. Congrats to all seniors
...
1. (If anything remains from Lec 35) LINE conditions required for theory/formula-based regression SE, HT, and CI to be valid:
    ...
    1. Independence of the residuals
    1. Normality of the residuals
    1. Equality of variance of the residuals
1. Simulation-based inference for population regression slope $\beta_1$ with `infer` framework (as opposed to R's regression tables which are based on theory/formula-based approach)
...
1. Don't forget about video lectures recorded during pandemic for select topics! In far-right column in schedule above. 
1. Midterm IV during finals week information posted
1. Resubmission phase of final project
    1. [Instructions](project.html#resubmission) posted
    1. Basic principle: minimize ink to information ratio
...
1. How are values in table computed? Not via simulations (like with `infer`) but using theory/formula-based approach.
1. (As much as we can get done today) LINE conditions required for theory/formula-based regression SE, HT, and CI to be valid:
    1. Linearity of relationship between variables
    1. Independence of the residuals
    1. Normality of the residuals
    1. Equality of variance of the residuals
...
1. Discussion about Midterm III [posted](midterms.html#midtermIII)
1. By Wednesday:
    1. Instructions for final phase of [final project](project.html#resubmission) posted
    1. Feedback delivered
1. Repeat announcement: SDS Focus Group  
    ```{r, echo=FALSE, out.width="50%"}
    include_graphics("static/events/2022-04-20-SDS-focusgroup-flyer.png")
    ```
...
1. Theory-based hypothesis tests
    1. t-tests
    1. Fig 9.22 compares theory-based approach and simulation-based approach
1. Controversy around p-values
1. Starting ModernDive Chapter 10: Inference for regression (Learning Goals 14 & 15 in blue)
    1. Refresher of simple linear regression: Fig 10.1 and Table 10.1
    1. Sampling scenario 5: Population regression slope $\beta_1$
