...
* First lab with Dr. Jenny Smetzer is tomorrow. Problem set 01 (PS01) will be posted on the [Problem Sets](PS.html) page.
...
1. As indicated in the above schedule, read ModernDive Chapter 2 while running all code in the *console*. You can skip all videos and the DataCamp links as we'll be talking about those in class.
