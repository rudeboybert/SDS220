...
1. Today: We discuss resampling from a single sample.
1. Watch this [mini-lecture](){target="_blank"}
...
1. Be sure to set the "time zone" in your own Google Calendar to match your location so that the appointment times appear correctly for you. For reference, Chichi's first Wed 4/1 appointment block is between 9:30am – 10:15am eastern.
