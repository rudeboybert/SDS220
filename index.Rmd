...
* Hand out solutions to practice midterm I
...
* Recap of Lec14: interaction and parallel slopes. Why one vs the other. "Is additional complexity warranted?" All other things being equal. Show how to use `gg_parallel_slopes()`
...
* Term project: I will
    ...
    + Post instructions for the next "Project proposal" phase by Wednesday; this phase is due Fri 3/8 5pm and involves data wrangling and exploratory data analysis. Here is a "work in progress" [preview](static/term_project/proposal_example.html){target="_blank"}; I will post a finalized version by Wednesday.
