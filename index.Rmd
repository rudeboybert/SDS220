...
The `r emo::ji("confused")``r emo::ji("face_with_head_bandage")``r emo::ji("dizzy_face")``r emo::ji("exploding_head")` statistical definitions/terminlogy behind hypothesis testing; in particular how hypothesis testing relates to **sampling**.
