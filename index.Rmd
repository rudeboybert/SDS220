...
1. Tips on understanding computer simulation code:
1. Go over MD Fig 7.9 and MD Table 7.1
...
# This form: https://docs.google.com/forms/d/1AIAm5Nb4FDYWJt3-xt8Pvh-Kin7eJoG_bkdqbrOK4aA/edit
library(tidyverse)
library(googlesheets4)
gs4_auth()

sampling_data <- "https://docs.google.com/spreadsheets/d/16S11oIT4FfitSA-cStKtN9oVFGG12QFDjCI1y35vEvk/edit#gid=0" %>%
  read_sheet()
...
# Virtual sampling bowl
bowl

# Take virtual sample of size n = 25, 41 times 
virtual_samples_25  <- bowl %>% 
  rep_sample_n(size = 25, reps = 41)
virtual_samples_25
