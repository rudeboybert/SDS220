...
1. **Originally skipped in Lec28**: MD 8.7.2 (LG 11)
    1. Theory-based method for computing standard errors (instead of simulations)
    1. Theory-based method for constructing confidence intervals (instead of simulations)
