...
* Based off [Parallel Slopes vs Interaction Models](static/multiple_regression.html){target="_blank"}. You can download the <a href="static/multiple_regression.Rmd" download>`multiple_regression.Rmd`</a> R Markdown file as well if you are curious. 
