...
* Term project groups are due this Friday 5pm; see [Items to Submit](). If you need a group, Slack me.
* Lab tomorrow: Jenny will talk about DataCamp

## Todays Topics/Activities       

### 1. Chalk talk

* Recap of Lec04: Facets
* Boxplot to show the *distribution* of a numerical variable split by a categorical variable.
* Compare faceted histogram [Figure 3.16](https://moderndive.netlify.com/3-viz.html#facets){target="_blank"} vs boxplot [Figure 3.23](https://moderndive.netlify.com/3-viz.html#geomboxplot){target="_blank"}
