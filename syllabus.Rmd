...
* The strain zone is the complete opposite of the safe zone.   
* A student in the strain zone feels completely overwhelmed with the material to the point where they can’t find any meaningful connections between the current material and what the student already knows. 
...
* Each full problem set is worth 100 pts and each lite problem set is worth 50 pts. So there are total of 750 possible pts, however the final computation will be out of **600 pts**. 
...
See [Badge Challenges](badge_challenges.html) page. Note that is possible to satisfy all 15 badges in the first three badge challenges, making the 4th badge challenge during exam week optional 
