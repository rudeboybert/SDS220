...
* **Communication**: All communication will take place via Slack.
    ...
    + You are required to check Slack at least once daily.
* **Lectures:**
...
* **Getting help**:
    ...
    + Check the drop-in office hours [Google Calendar](https://calendar.google.com/calendar/embed?src=smith.edu_qd5sufjufbms2430ielqeego24%40group.calendar.google.com&ctz=America%2FToronto){target="_blank"}
    + Schedule one-on-one appointments with a Spinelli Tutor. Instructions will be posted here shortly.
    + Schedule one-on-one appointments with the instructors or lab instructors. Instructions on [Moodle](https://moodle.smith.edu/course/view.php?id=37125){target="_blank"}. In the interest of keeping everyone in the loop, we ask as much as possible to limit these appointments to private/individual concerns.
...
*Revised: While the mechanics of taking/submitting the badge challenges have changed since we no longer have access to Seelye self-scheduled exams, the philosophy and format of our badge challenges will remain the same. See the [Badge Challenges](badge_challenges.html) page for more details.*
